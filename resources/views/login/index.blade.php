...
<div class='my-3 h-40 rounded max-w-lg'>
    ...
    <form action="POST" class='bg-white p-10'>

        <div class="mb-4">
            <label for="Username" class='block font-bold mb-2 '>Username</label>
            <input type="text" placeholder="Username" class='w-full border shadow py-2 px-4'>
        </div>

        <div class="mb-4">
            <label for="Password" class='block font-bold mb-2'>Password</label>
            <input type="password" placeholder="password" class='border shadow w-full py-2 px-4'>
        </div>
